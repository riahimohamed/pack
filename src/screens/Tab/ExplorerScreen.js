...
import { StyleSheet, View, Constants, Platform } from 'react-native';
...
export default function ExplorerScreen({ navigation }) {
    ...
    const handleLocation = async () => {
        ...
        if (coords) {
            ...
            for (let item of response) {
                ...
                address = `${item.country}, ${item.subregion} ${item.street}`;
    ...
    const handleSubmit = (values) => {
        navigation.navigate('BuyTicket', {values, displayCurrentAddress})
    }
                    ...
                    <View style={{ width: '90%' }}>
                        ...
                        >
                            ...
                            <View style={styles.justify}>
                                ...
                                <Counter onPress={increment} counter={count} />
                            </View>
