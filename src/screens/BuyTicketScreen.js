...
export default function TicketScreen({navigation, route}) {
    ...
    const departDate = moment().add(15, 'minutes').format("HH:mm")
                    ...
                    <View style={styles.cardBody} >
                        <View style={styles.row}>
                            <View >
                                ...
                                <Text h4 h4Style={styles.textBody}>{displayCurrentAddress}</Text>
                            </View>
                            <View>
                                <Text style={styles.textStation}>Depart</Text>
                                <Text h4 h4Style={styles.textBody}>{ currentDate }</Text>
                            </View>
                        </View>
                        <View style={styles.row}>
                            <View>
                                <Text style={styles.textStation}>Station <Badge value={values.station.station} status="success" /></Text>
                                <Text h4 h4Style={styles.textBody}>{values.station.name}</Text>
                            </View>
                            <View>
                                <Text style={styles.textStation}>Arrivée</Text>
                                <Text h4 h4Style={styles.textBody}>{ departDate }</Text>
                            </View>
                        </View>
                    </View>
                        ...
                        <View style={styles.justify}>
                            <View style={{alignItems: 'center'}}>
                                <Icon reverse name='map' size={20} 
                                    onPress={() => navigation.navigate('Maps', route.params)} />
